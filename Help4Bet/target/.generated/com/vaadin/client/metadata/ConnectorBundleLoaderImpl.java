...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Link","com.vaadin.ui.ComboBox","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.Table","com.vaadin.ui.OptionGroup","com.vaadin.ui.Embedded","com.vaadin.ui.TextField","com.vaadin.ui.BrowserFrame","com.vaadin.ui.JavaScript","com.vaadin.ui.CssLayout","com.vaadin.ui.MenuBar","com.vaadin.ui.TreeTable","com.vaadin.ui.PopupView","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.FormLayout","com.vaadin.ui.Panel","com.vaadin.ui.ProgressBar","com.vaadin.ui.Audio","com.vaadin.ui.Tree","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Upload","com.vaadin.ui.NativeButton","com.vaadin.ui.NativeSelect","com.vaadin.ui.Flash","com.vaadin.ui.CustomField","com.vaadin.ui.Window","com.vaadin.ui.DateField","com.vaadin.ui.UI","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Label","com.vaadin.ui.CustomComponent","com.vaadin.ui.TextArea","com.vaadin.ui.CheckBox","com.vaadin.ui.Accordion","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.ListSelect","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Slider","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.CustomLayout","com.vaadin.ui.PasswordField","com.vaadin.ui.Video","com.vaadin.ui.GridLayout","com.vaadin.server.FileDownloader","com.vaadin.ui.InlineDateField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.Button","com.vaadin.ui.Form",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"checked", "primaryStyleName", "registeredEventListeners", "tabIndex", "caption", "resources", "hideErrors", "height", "errorMessage", "styles", "modified", "description", "readOnly", "enabled", "propertyReadOnly", "width", "immediate", "id", "required", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"enabled", "errorMessage", "styles", "width", "secondChild", "splitterState", "readOnly", "height", "firstChild", "registeredEventListeners", "primaryStyleName", "resources", "immediate", "description", "caption", "id", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"hideErrors", "propertyReadOnly", "immediate", "registeredEventListeners", "modified", "errorMessage", "height", "description", "primaryStyleName", "styles", "enabled", "resources", "id", "width", "required", "caption", "tabIndex", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"errorMessage", "description", "caption", "height", "id", "primaryStyleName", "enabled", "scrollLeft", "immediate", "tabIndex", "registeredEventListeners", "readOnly", "styles", "width", "resources", "scrollTop", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"errorMessage", "caption", "tooltipConfiguration", "localeServiceState", "pushConfiguration", "resources", "primaryStyleName", "height", "width", "loadingIndicatorConfiguration", "tabIndex", "styles", "enabled", "overlayContainerLabel", "pageState", "registeredEventListeners", "description", "pollInterval", "id", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"closeTimeout", "maxWidth", "openDelay", "quickOpenDelay", "quickOpenTimeout", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"errorMessage", "resources", "parameters", "readOnly", "target", "registeredEventListeners", "id", "height", "description", "primaryStyleName", "enabled", "caption", "width", "styles", "uriFragment", "features", "immediate", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"contentMode", "description", "id", "text", "width", "enabled", "errorMessage", "primaryStyleName", "caption", "readOnly", "height", "registeredEventListeners", "resources", "styles", "immediate", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"spacing", "width", "id", "immediate", "description", "height", "caption", "primaryStyleName", "readOnly", "marginsBitmask", "enabled", "errorMessage", "resources", "childData", "styles", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"resources", "modified", "tabIndex", "height", "propertyReadOnly", "registeredEventListeners", "enabled", "width", "caption", "id", "required", "styles", "hideErrors", "description", "readOnly", "primaryStyleName", "immediate", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"description", "inputPrompt", "maxLength", "errorMessage", "modified", "readOnly", "enabled", "tabIndex", "primaryStyleName", "hideErrors", "height", "propertyReadOnly", "immediate", "text", "caption", "registeredEventListeners", "id", "columns", "required", "styles", "resources", "width", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"width", "errorMessage", "immediate", "caption", "height", "resources", "registeredEventListeners", "readOnly", "styles", "primaryStyleName", "id", "enabled", "description", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"description", "resources", "styles", "errorMessage", "hideErrors", "required", "height", "immediate", "caption", "readOnly", "registeredEventListeners", "enabled", "id", "propertyReadOnly", "tabIndex", "width", "modified", "primaryStyleName", });
            store.setProperties(java.util.Date.class, new String[] {"date", "minutes", "seconds", "month", "hours", "year", "time", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"hideErrors", "modified", "caption", "description", "width", "registeredEventListeners", "rangeEnd", "tabIndex", "rangeStart", "propertyReadOnly", "required", "height", "errorMessage", "readOnly", "resources", "immediate", "enabled", "id", "styles", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"styles", "enabled", "caption", "height", "width", "primaryStyleName", "readOnly", "errorMessage", "description", "registeredEventListeners", "immediate", "resources", "id", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"altText", "htmlContentAllowed", "sourceTypes", "muted", "caption", "width", "id", "immediate", "enabled", "autoplay", "readOnly", "primaryStyleName", "height", "resources", "description", "errorMessage", "styles", "registeredEventListeners", "showControls", "sources", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LoadingIndicatorConfigurationState.class, new String[] {"secondDelay", "firstDelay", "thirdDelay", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"immediate", "caption", "width", "description", "styles", "height", "registeredEventListeners", "readOnly", "errorMessage", "resources", "alternateText", "primaryStyleName", "enabled", "id", });
            store.setProperties(com.vaadin.shared.communication.SharedState.class, new String[] {"enabled", "resources", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"rpcInterfaces", "resources", "height", "readOnly", "description", "caption", "errorMessage", "immediate", "callbackNames", "styles", "primaryStyleName", "width", "registeredEventListeners", "enabled", "id", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"caption", "draggable", "registeredEventListeners", "styles", "id", "resizeLazy", "scrollLeft", "modal", "height", "immediate", "description", "centered", "enabled", "windowMode", "width", "positionX", "errorMessage", "positionY", "tabIndex", "resources", "readOnly", "primaryStyleName", "resizable", "scrollTop", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"readOnly", "enabled", "modified", "primaryStyleName", "propertyReadOnly", "tabIndex", "registeredEventListeners", "width", "resources", "id", "description", "hideErrors", "height", "caption", "errorMessage", "styles", "required", "immediate", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"styles", "readOnly", "immediate", "resources", "classId", "alternateText", "registeredEventListeners", "id", "enabled", "height", "codetype", "primaryStyleName", "embedParams", "width", "archive", "description", "codebase", "errorMessage", "caption", "standby", });
            ...
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"required", "description", "immediate", "modified", "caption", "id", "width", "registeredEventListeners", "hideErrors", "errorMessage", "styles", "propertyReadOnly", "readOnly", "tabIndex", "enabled", "resources", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"errorMessage", "width", "modified", "id", "tabIndex", "enabled", "resources", "description", "styles", "immediate", "height", "readOnly", "caption", "required", "propertyReadOnly", "registeredEventListeners", "hideErrors", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"primaryStyleName", "childData", "width", "resources", "errorMessage", "marginsBitmask", "styles", "height", "description", "enabled", "readOnly", "caption", "immediate", "columns", "registeredEventListeners", "rows", "id", "spacing", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"readOnly", "styles", "immediate", "enabled", "resources", "html", "primaryStyleName", "caption", "id", "height", "registeredEventListeners", "width", "description", "errorMessage", "hideOnMouseOut", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "registeredEventListeners", "rpcInterfaces", "enabled", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"primaryStyleName", "styles", "registeredEventListeners", "errorMessage", "hideErrors", "propertyReadOnly", "description", "id", "modified", "state", "required", "immediate", "resources", "caption", "indeterminate", "tabIndex", "height", "width", "readOnly", "enabled", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"caption", "registeredEventListeners", "required", "propertyReadOnly", "enabled", "height", "readOnly", "tabIndex", "errorMessage", "primaryStyleName", "pollingInterval", "state", "hideErrors", "id", "styles", "width", "indeterminate", "modified", "description", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"shiftKey", "clientX", "clientY", "button", "metaKey", "type", "ctrlKey", "relativeY", "relativeX", "altKey", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"width", "errorMessage", "caption", "immediate", "readOnly", "enabled", "styles", "description", "registeredEventListeners", "height", "id", "resources", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"enabled", "showControls", "resources", "primaryStyleName", "id", "registeredEventListeners", "errorMessage", "width", "sourceTypes", "height", "styles", "htmlContentAllowed", "autoplay", "altText", "readOnly", "caption", "sources", "immediate", "muted", "description", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"resources", "registeredEventListeners", "id", "immediate", "disableOnClick", "styles", "enabled", "clickShortcutKeyCode", "height", "readOnly", "caption", "htmlContentAllowed", "primaryStyleName", "tabIndex", "description", "errorMessage", "width", "iconAltText", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"enabled", "id", "resources", "childCss", "caption", "width", "readOnly", "immediate", "registeredEventListeners", "primaryStyleName", "styles", "description", "height", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"resources", "primaryStyleName", "height", "caption", "readOnly", "enabled", "registeredEventListeners", "width", "errorMessage", "description", "immediate", "connectorToCssPosition", "id", "styles", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionReversed", "maxPositionUnit", "maxPosition", "minPositionUnit", "minPosition", "positionUnit", "position", "locked", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"errorMessage", "description", "styles", "required", "width", "enabled", "descriptionForAssistiveDevices", "readOnly", "modified", "hideErrors", "primaryStyleName", "tabIndex", "resources", "rangeEnd", "rangeStart", "textFieldEnabled", "propertyReadOnly", "height", "caption", "registeredEventListeners", "id", "immediate", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"width", "hideErrors", "readOnly", "registeredEventListeners", "immediate", "description", "errorMessage", "height", "propertyReadOnly", "resources", "modified", "id", "required", "primaryStyleName", "tabIndex", "styles", "enabled", "caption", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"height", "description", "registeredEventListeners", "footer", "propertyReadOnly", "width", "resources", "errorMessage", "layout", "readOnly", "caption", "styles", "required", "enabled", "hideErrors", "immediate", "primaryStyleName", "tabIndex", "id", "modified", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"rows", "wordwrap", "enabled", "propertyReadOnly", "required", "tabIndex", "id", "hideErrors", "columns", "immediate", "readOnly", "modified", "registeredEventListeners", "primaryStyleName", "inputPrompt", "description", "maxLength", "resources", "caption", "height", "text", "width", "styles", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"twelveHourClock", "shortMonthNames", "dayNames", "am", "dateFormat", "name", "hourMinuteDelimiter", "firstDayOfWeek", "pm", "shortDayNames", "monthNames", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"id", "caption", "spacing", "marginsBitmask", "styles", "childData", "height", "registeredEventListeners", "enabled", "readOnly", "errorMessage", "description", "immediate", "width", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"width", "disableOnClick", "readOnly", "styles", "htmlContentAllowed", "registeredEventListeners", "tabIndex", "primaryStyleName", "description", "id", "iconAltText", "enabled", "errorMessage", "clickShortcutKeyCode", "height", "immediate", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"childLocations", "resources", "description", "id", "styles", "caption", "errorMessage", "enabled", "primaryStyleName", "templateContents", "readOnly", "width", "height", "immediate", "registeredEventListeners", "templateName", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "column2", "column1", "row2", "row1", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"description", "readOnly", "resources", "registeredEventListeners", "primaryStyleName", "styles", "height", "id", "alternateText", "enabled", "width", "immediate", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"description", "id", "errorMessage", "caption", "spacing", "marginsBitmask", "immediate", "styles", "height", "resources", "readOnly", "registeredEventListeners", "primaryStyleName", "childData", "width", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"errorMessage", "resources", "styles", "description", "propertyReadOnly", "width", "minValue", "caption", "primaryStyleName", "orientation", "enabled", "readOnly", "registeredEventListeners", "required", "id", "height", "value", "modified", "tabIndex", "maxValue", "immediate", "resolution", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"errorMessage", "caption", "registeredEventListeners", "readOnly", "enabled", "tabIndex", "description", "styles", "id", "immediate", "primaryStyleName", "height", "width", "resources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"primaryStyleName", "caption", "resources", "id", "registeredEventListeners", "description", "width", "readOnly", "height", "secondChild", "errorMessage", "splitterState", "enabled", "styles", "immediate", "firstChild", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"registeredEventListeners", "styles", "immediate", "errorMessage", "description", "alternateText", "primaryStyleName", "height", "resources", "id", "width", "readOnly", "caption", "enabled", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"actionKey", "caption", "startDate", "endDate", "iconKey", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"registeredEventListeners", "width", "firstVisibleDayOfWeek", "monthNames", "lastVisibleDayOfWeek", "resources", "id", "events", "now", "errorMessage", "enabled", "caption", "actions", "scroll", "firstHourOfDay", "immediate", "firstDayOfWeek", "format24H", "description", "styles", "height", "primaryStyleName", "dayNames", "lastHourOfDay", "days", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"date", "week", "localizedDateFormat", "dayOfWeek", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"timeTo", "index", "styleName", "caption", "allDay", "description", "timeFrom", "dateFrom", "dateTo", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"readOnly", "width", "caption", "registeredEventListeners", "errorMessage", "enabled", "resources", "bgColor", "height", "styles", "description", "cursorY", "cursorX", "immediate", "primaryStyleName", "id", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"enabled", "htmlContentAllowed", "primaryStyleName", "height", "readOnly", "id", "showDefaultCaption", "resources", "registeredEventListeners", "styles", "color", "popupVisible", "width", "description", "errorMessage", "immediate", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"styles", "resources", "height", "readOnly", "primaryStyleName", "caption", "errorMessage", "id", "changedColor", "description", "width", "columnCount", "immediate", "registeredEventListeners", "rowCount", "changedX", "changedY", "enabled", });
